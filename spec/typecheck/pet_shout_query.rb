...
module PetShoutQuery
  extend T::Sig

  QUERY = T.let(<<~'GRAPHQL', String)
    query PetShout { person(id: 1) { pets { name } } }
  GRAPHQL

  # sent as the request's operationName — what an APM keys traces on
  OPERATION_NAME = T.let("PetShout", T.nilable(String))
  ...
  class Result < T::Struct
    ...
    class Person < T::Struct
      ...
      class Pets < T::Struct
        ...
        include GraphWeaver::Hints
        include GraphWeaver::ResultStruct
        include GraphWeaver::TypeHelpers::Pet # registered for Pet
  ...
  sig { params(client: T.untyped).returns(GraphWeaver::Response[Result]).checked(:never) }
