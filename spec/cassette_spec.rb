...
describe GraphWeaver::Testing::Cassette do
  ...
  describe "#anonymize!" do
    ...
    # and anonymization runs through the same engine as the fake — so the
    # suite's pin for the type has to reach both, or scrubbing a cassette is
    # what breaks it.
    it "keeps an app-class scalar castable, from the suite's pin for it" do
