...
`0.7.7` published to RubyGems (2026-09-25), after `0.7.6` (2026-09-21),
`0.7.5` (2026-09-20), `0.7.4` (2026-09-17), `0.7.3` (2026-09-16), `0.7.2`
(2026-09-15), `0.7.1` (2026-09-14) and `0.7.0` (2026-09-13). 0.7.0's
CHANGELOG entry is the diff from 0.6.1 — multi-graph
...
example regenerated by the build; 0.7.7 answers the second real user report:
a generated tree Zeitwerk would name correctly is left to Zeitwerk, and a
namespaced graph's types module is `Types` so `namespace:` alone aligns it.
The upgrade guide has a checklist per step;
